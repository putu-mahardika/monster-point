...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('img/logo_ps.png') }}" rel="icon">
    <link href="{{ asset('img/logo_ps.png') }}" rel="apple-touch-icon">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="rounded-xxl getstarted scrollto" href="{{ url('/login') }}">Login</a></li>
                </ul>
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="600">
                        <div class="text-center text-lg-start">
                            <a href="#"
                                class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center rounded-xxl">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-box orange">
                            ...
                            <a href="#" class="read-more rounded-xxl"><span>Read More</span> <i
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="info-box">
                                    <a href="https://goo.gl/maps/YPUeW8jrF8sQMGEf6"><i class="bi bi-geo-alt"></i></a>
                                    <h3>Address</h3>
                                    <p>Nirwana Eksekutif Blok BB-359A, Jl. Wonorejo Permai Utara V No.2,<br>Wonorejo,
                                        Kec. Rungkut, Kota SBY, Jawa Timur 60296</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    <a href="tel:+6281-910-577-999"></a><i class="bi bi-telephone"></i>
                                    <h3>Call Us</h3>
                                    <a href="tel:+6281-910-577-999">
                                        <p>+6281-910-577-999</p>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    <a href="mailto:marketing@monstergroup.co.id"><i class="bi bi-envelope"></i></a>
                                    <h3>Email Us</h3>
                                    <a href="mailto:marketing@monstergroup.co.id">
                                        <p>@monstergroup.co.id</p>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <form action="" method="post">
                            <input class="" type="email" name="email"><input class="btn rounded-xxl" type="submit"
                                value="Subscribe">
                        </form>
                    </div>
                </div>
