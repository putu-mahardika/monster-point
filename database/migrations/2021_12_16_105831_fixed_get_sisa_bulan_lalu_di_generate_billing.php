...
class FixedGetSisaBulanLaluDiGenerateBilling extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        BEGIN
            ...
            (
                SELECT COUNT(*) FROM Billing WHERE IdMerchant = @idMerchant AND date_end = @dateEnd
            );

            IF @countBilling = 0			 -- jika invoice belum dibuat
                BEGIN
